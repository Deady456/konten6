...
export const FacelessVideo: React.FC<FacelessVideoProps> = ({
  ...
  return (
    <AbsoluteFill style={{ backgroundColor: "#111122" }}>
      ...
      <style>
        {`
          @import url('https://fonts.googleapis.com/css2?family=Montserrat:ital,wght@0,800;0,900;1,800&family=Bebas+Neue&display=swap');
          
          .hook-text {
            background: linear-gradient(90deg, #B8860B 0%, #FFFFFF 100%);
        ...
        {currentTime < 2 && title && (
          <div
            ...
            style={{
              ...
              fontWeight: 900,
              fontFamily: "'Bebas Neue', cursive", // Font unik
